...
struct Achievement: Identifiable, Codable {
    ...
    static let allAchievements: [Achievement] = [
        ...
        Achievement(id: "first_lesson", title: "नमस्ते!", description: "Complete your first lesson", icon: "star.fill", requirement: 1, rewardStars: 5, rewardCoins: 10, isUnlocked: false, progress: 0),
...
struct Badge: Identifiable, Codable {
    ...
    var badgeColor: Color {
        switch color {
        case "gold": return AppTheme.brandGold
    ...
    static let allBadges: [Badge] = [
        Badge(id: "beginner", name: "Beginner", icon: "leaf.fill", color: "green", description: "Started learning Nepali", isEarned: false),
...
struct Reward: Identifiable, Codable {
    ...
    static let availableRewards: [Reward] = [
        ...
        // Sound Packs
        Reward(id: "sound_traditional", name: "Traditional Sounds", description: "Traditional Nepali instruments", icon: "speaker.wave.3.fill", cost: 150, isPurchased: false, category: .soundPack),
...
struct Mascot {
    ...
    func getMessage(for situation: MascotSituation) -> String {
        switch situation {
        case .welcome:
            return "नमस्ते! Ready to learn today?"
        case .lessonStart:
...
enum MiniGameType: String, CaseIterable, Identifiable {
    ...
    var color: Color {
        ...
        case .speaking: return AppTheme.readingColor
        }
    }
}
