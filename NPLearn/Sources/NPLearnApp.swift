...
//  NPLearn
//
//  Main application entry point for Nepali Learning App
//
...
struct NPLearnApp: App {
    ...
    init() {
        ...
        print("🚀 NPLearn launched - Nepali Learning App")
    }
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 24) {
                ...
                Text("नमस्ते...")
                    .font(AppTheme.Typography.nepaliTitle)
