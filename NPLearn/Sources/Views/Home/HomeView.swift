                    ...
                    VStack(spacing: 16) {
                        ...
                        HStack(spacing: 16) {
                            VStack(alignment: .leading, spacing: 8) {
                                ...
                                Text("Start with Devanagari practice")
...
struct VowelsView: View {
    ...
    // Based on https://www.easynepalityping.com/nepali-alphabet
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("Vowels in Nepali")
                    .font(AppTheme.Typography.headline)
                
                Text("Tap any character to hear its pronunciation. Independent vowels are used at the beginning of syllables.")
                ...
                LazyVGrid(columns: [
                    ...
                    ForEach(independentVowels, id: \.0) { vowel in
                        CharacterCard(
                            ...
                            Haptics.selection()
                            Task {
                                await audioService.speak(text: vowel.0, language: "ne-NP")
                            }
                        }
                    }
                }
                    ...
                    ForEach(dependentVowels, id: \.0) { vowel in
                        CharacterCard(
                            ...
                            Task {
                                ...
                                await audioService.speak(text: "क\(vowel.0)", language: "ne-NP")
                            }
                        }
                    }
                }
            ...
            LazyVGrid(columns: [
                ...
                ForEach(consonants, id: \.0) { consonant in
                    CharacterCard(
                        ...
                        Haptics.selection()
                        Task {
                            await audioService.speak(text: consonant.0, language: "ne-NP")
                        }
                    }
                }
            }
...
struct NumeralsView: View {
    ...
    let numerals: [(String, String, String)] = [
        ("०", "0", "शून्य"), ("१", "1", "एक"), ("२", "2", "दो"), 
        ("३", "3", "तीन"), ("४", "4", "चार"), ("५", "5", "पाँच"),
        ("६", "6", "छः"), ("७", "7", "सात"), ("८", "8", "आठ"), ("९", "9", "नौ")
    ]
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("Nepali Numerals")
                    .font(AppTheme.Typography.headline)
                
                Text("Tap any number to hear its pronunciation. Nepali has its own numeral system written in Devanagari script.")
                    .font(AppTheme.Typography.body)
                    .foregroundColor(AppTheme.mutedText)
            }
            .cardStyle()
            ...
            LazyVGrid(columns: [
                ...
                ForEach(numerals, id: \.0) { numeral in
                    CharacterCard(
                        ...
                        Haptics.selection()
                        Task {
                            // Speak the number name in Nepali/Hindi
                            await audioService.speak(text: numeral.2, language: "ne-NP")
                        }
                    }
                }
            }
            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                VStack(spacing: 12) {
                    ...
                    NumberExampleRow(
                        ...
                        english: "2025",
                        audioService: audioService,
                        spokenText: "two zero two five"
                    )
                    NumberExampleRow(
                        nepali: "९८७६५", 
                        english: "98765",
                        audioService: audioService,
                        spokenText: "nine eight seven six five"
                    )
                }
                .padding(.horizontal, AppTheme.Layout.horizontalPadding)
            }
    ...
    var body: some View {
        VStack(spacing: 20) {
            VStack(spacing: 12) {
                ...
                Text("Learn to write Devanagari characters")
                    .font(AppTheme.Typography.body)
                    .foregroundColor(AppTheme.mutedText)
            ...
            NavigationLink(destination: DevanagariWritingPracticeView()) {
                VStack(spacing: 16) {
                    ...
                    VStack(spacing: 4) {
                        ...
                        Text("Draw and practice characters")
                            .font(AppTheme.Typography.body)
                            .foregroundColor(AppTheme.mutedText)
                            .multilineTextAlignment(.center)
                    }
...
struct NumberExampleRow: View {
    ...
    var body: some View {
        Button(action: {
            Haptics.selection()
            Task {
                await audioService.speak(text: spokenText, language: "ne-NP")
            }
        }) {
            HStack {
                Text(nepali)
